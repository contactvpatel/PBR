...
using ICategoryService = PBR.Application.Interfaces.ICategoryService;
using IProductService = PBR.UI.Interfaces.IProductService;

namespace PBR.UI.Services
{
    public class ProductPageService : IProductService
    {
        ...
        public ProductPageService(Application.Interfaces.IProductService productAppService, ICategoryService categoryAppService, IMapper mapper, ILogger<ProductPageService> logger)
        {
