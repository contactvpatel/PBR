...
namespace PBR.PBR_Api.Services
{
    public class PowerBiAccountService : IPowerBiInterface
    {
        ...
        public async Task<PowerBiAccountViewModel> UpdateAccount(PowerBiAccountViewModel powerBiAccountViewModel)
        {
            var ViewModelToAccountModel = _mapper.Map<AccountModel>(powerBiAccountViewModel);
            var UpdateData= await _powerBiService.AccountUpdate(ViewModelToAccountModel);
            var GetUpdateData = _mapper.Map<PowerBiAccountViewModel>(UpdateData);
