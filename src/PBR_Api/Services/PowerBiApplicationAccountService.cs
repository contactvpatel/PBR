...
namespace PBR.PBR_Api.Services
{
    public class PowerBiApplicationAccountService: IPowerBiInterface
    {
        ...
        public async Task<PowerBiAppliactionAccountViewModel> GetApplicationAccountById(int id)
        {
        ...
        public async Task<PowerBiAppliactionAccountViewModel> UpdateApplicationAccount(PowerBiAppliactionAccountViewModel powerBiAccountViewModel)
        {
             var ViewModelToAccountModel = _mapper.Map<ApplicationAccountModel>(powerBiAccountViewModel);

              var UpdateApplicationAccount=  await _powerBiService.ApplicationAccountUpdate(ViewModelToAccountModel);
            var GetUpdateApplicationAccount = _mapper.Map<PowerBiAppliactionAccountViewModel>(UpdateApplicationAccount);
